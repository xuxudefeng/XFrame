...
namespace SaveSystem
{
    public abstract class SaveSystemBase
    {
        ...
        protected SaveSystemSettings _settings;
        ...
        protected void Load(bool rootMightNotExist)
        {
            ...
            if (string.IsNullOrEmpty(json))
            {
                ...
                throw new SaveSystemException("Root does not exist");
            }
            ...
            {
                throw new SaveSystemException("Deserialisation failed", e);
            }
        }
        ...
        protected void Save()
        {
            ...
            {
                throw new SaveSystemException("Serialisation failed", e);
            }
