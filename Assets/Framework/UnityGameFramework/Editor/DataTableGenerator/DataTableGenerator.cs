...
namespace UnityGameFramework.Editor.DataTableTools
{
    ...
    {
        public static DataTableGeneratorSettings Settings
        {
            get
            {
                return settings;
        ...
        private static DataTableGeneratorSettings settings = Resources.Load<DataTableGeneratorSettings>("DataTableGeneratorSettings");
        private static readonly Regex EndWithNumberRegex = new Regex(@"\d+$");
        private static readonly Regex NameRegex = new Regex(@"^[A-Z][A-Za-z0-9_]*$");

        public static DataTableProcessor CreateDataTableProcessor(string dataTableName)
        {
            return new DataTableProcessor(Utility.Path.GetRegularPath(Path.Combine(settings.DataTablePath, dataTableName + ".txt")), Encoding.GetEncoding("GB2312"), 1, 2, null, 3, 4, 1);
        }
        ...
        {
            string binaryDataFileName = Utility.Path.GetRegularPath(Path.Combine(settings.DataTablePath, dataTableName + ".bytes"));
        ...
        {
            dataTableProcessor.SetCodeTemplate(settings.CSharpCodeTemplateFileName, Encoding.UTF8);
            dataTableProcessor.SetCodeGenerator(DataTableCodeGenerator);

            string csharpCodeFileName = Utility.Path.GetRegularPath(Path.Combine(settings.CSharpCodePath, "DR" + dataTableName + ".cs"));
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "UnityGameFramework");
