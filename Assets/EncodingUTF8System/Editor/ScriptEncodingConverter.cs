...
public class ScriptEncodingConverter
{
    ...
    const string menu2UTF8 = "Assets/Encoding To UTF8";
    const string menu2GB2312 = "Assets/Encoding To GB2312(测试用)";
    const string menuAuto = "Assets/Enable Auto Fix";
    ...
    static void SwitchAutoFixState()
    {
        ...
        Menu.SetChecked(menuAuto, value);
    }
    /// <summary>
    /// 初始化 <see cref="menu_auto"/> 菜单的 checked 状态
    /// </summary>
    /// <returns></returns>
    [MenuItem(menuAuto, validate = true)]
    ...
    /// <summary>
    /// 将脚本编码格式转换为 GB2312 (测试用)
    /// </summary>
    [MenuItem(menu2GB2312, priority = 0)]
