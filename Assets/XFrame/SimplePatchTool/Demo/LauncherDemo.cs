...
public class SimplePatchTool1 : MonoBehaviour
{
    private void Awake()
    {
...
#pragma warning restore 0649
        ...
        private IEnumerator FetchPatchNotes()
        {
            ...
            bool webRequestError = (webRequest.result == UnityWebRequest.Result.ProtocolError);// webRequest.isHttpError || webRequest.isNetworkError;
            if (!webRequestError)
