...
public class MessageManager
{
    ...
    public static void SendMessage(short eventType)
    {
        Delegate d;
    ...
    public static void SendMessage<T>(short eventType, T arg1)
    {
        Delegate d;
        if (eventTable.TryGetValue(eventType, out d))
        {
    ...
    public static void SendMessage<T, U>(short eventType, T arg1, U arg2)
    {
        Delegate d;
        if (eventTable.TryGetValue(eventType, out d))
        {
