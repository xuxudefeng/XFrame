...
public class HorizontalList<T1> : IGameList
...
public class HorizontalList<T1, T2> : IGameList
...
public class HorizontalList<T1, T2, T3> : IGameList
...
public class HorizontalList<T1, T2, T3, T4> : IGameList
