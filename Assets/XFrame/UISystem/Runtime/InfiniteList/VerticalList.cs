...
public class VerticalList<T1> : IGameList
    where T1 : IMappedObject, new()
{
    ...
    public VerticalList(ScrollRect scrollRect, T1 original1)
    {
        ...
        var gameList = this.scrollRect.gameObject.AddComponent<GameList>();
        gameList.List = new ListOperator(this);
    ...
    private class ListOperator : IGameListMonoBehaviourBridge
    {
...
public class VerticalList<T1, T2> : IGameList
...
public class VerticalList<T1, T2, T3> : IGameList
    where T1 : IMappedObject, new() where T2 : IMappedObject, new() where T3 : IMappedObject, new()
{
    ...
    public VerticalList(ScrollRect scrollRect, T1 original1, T2 original2, T3 original3)
    {
        ...
        var kuchenList = this.scrollRect.gameObject.AddComponent<GameList>();
...
public class VerticalList<T1, T2, T3, T4> : IGameList
